...
class SaveRepository(private val saveDAO: SaveDAO) : InSaveRepository {
    ...
    override suspend fun setMachineStates(gameID: Long, oldState: String, newState: String) =
        saveDAO.setMachineStates(gameID, oldState, newState)

    override suspend fun setCurrentPlayer(gameID: Long, playerID: Long) =
        saveDAO.setCurrentPlayer(gameID, playerID)

    override suspend fun setStateProcessed(gameID: Long, processed: Boolean) =
        saveDAO.setStateProcessed(gameID, processed)
}