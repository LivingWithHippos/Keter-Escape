...
class VoteRepository(private val voteDAO: VoteDAO, private val turnDAO: TurnDAO) : InVoteRepository {

    override suspend fun insertVote(vote: Vote) = voteDAO.insertVote(vote)

    override suspend fun insertCurrentTurnVote(gameID: Long, votedPlayerId: Long,voteType: String) {
