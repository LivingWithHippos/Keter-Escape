...
class TurnRepository(private val turnDAO: TurnDAO): InTurnRepository {
    ...
    override fun getPlayerTurns(gameID: Long, playerID: Long): Flowable<List<Turn>> = turnDAO.getPlayerTurns(gameID, playerID)

    override fun getRoundTurns(gameID: Long, roundNumber: Int): Flowable<List<Turn>> = turnDAO.getRoundTurns(gameID, roundNumber)
